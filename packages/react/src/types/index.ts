...
> = {
  ...
  onClientVeluyComplete?: // | ((res: ClientVeluyCompletedData<TServerOutput>[]) => MaybePromise<void>)
  any | undefined;
  /**
   * Called if the upload fails
   */
  onVeluyError?: // | ((e: VeluyError<inferErrorShape<TFileRoute>>) => MaybePromise<void>)
  any | undefined;
  /**
