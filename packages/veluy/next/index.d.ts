...
declare const createVeluy: <TErrorShape extends Json>(
  opts?: CreateBuilderOptions<TErrorShape>,
) => <TRouteOptions extends _veluy_shared.RouteOptions>(
  input: any,
  config?: TRouteOptions,
) => ___internal_types.VeluyBuilder<{
...
declare const createRouteHandler: <TRouter extends TransactionRouter>(
