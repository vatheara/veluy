...
export {
  ...
  TransactionRoute,
  UTRegionAlias,
} from "../dist/_internal/types.js";

type TransactionRouter = Record<string, AnyTransactionRoute>;
type inferEndpointInput<TTransactionRoute extends AnyTransactionRoute> =
  TTransactionRoute["$types"]["input"];
type inferEndpointOutput<TTransactionRoute extends AnyTransactionRoute> =
  TTransactionRoute["$types"]["output"];
type inferErrorShape<TTransactionRoute extends AnyTransactionRoute> =
...
>;
type CreateTransactionCheckOptions<
