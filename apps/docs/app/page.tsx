    ...
    <main className="min-h-screen bg-[#f3f4f6] text-gray-800">
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 px-6 bg-white text-black">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">
          Veluy - <span className="font-km">វេលុយ</span>
        </h1>
        <p className="text-lg md:text-2xl max-w-2xl capitalize">
          A library to build payment integration with{" "}
          <Link
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p>
              Easy to use and build for payment integration with{" "}
              <Link
                href="https://bakong.nbc.gov.kh/"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p>
              Support multiple frameworks like{" "}
              <span className="font-bold">React.js</span>,{" "}
              <span className="font-bold">React Native</span>,{" "}
              <span className="font-bold">Flutter</span>, etc.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p>
              MIT-licensed and open for contribution by developers around the
              world.
            </p>
          </div>
        </div>
